...
export default class pwdLeavel extends React.Component {
  ...
  renderLevel = (level) => {
    if (level <= 1) {
      return [
        <li className={less.active1} key="01"></li>,
        <li key="02"></li>,
        <li key="03"></li>
      ]
    } else if (level == 2) {
      return [
        <li className={less.active2} key="11"></li>,
        <li className={less.active2} key="12"></li>,
        <li key="13"></li>
      ]
    } else {
      return [
        <li className={less.active3} key="21"></li>,
        <li className={less.active3} key="22"></li>,
        <li className={less.active3} key="23"></li>
      ]
    }
  }
  renderTip = (level) => {
