import { Card, Form, Row, Col, Modal, Button, DatePicker, Select } from 'antd';
...
class ModalFormComponent extends React.Component {
  ...
  initNode = () => {
    ...
    if (this.props.obj.effective == "1") {
      return [
        ...
        <FormItem {...formItemLayout} label="来源" key='2'>
          <Select
            placeholder='请选择来源'
            {...getFieldProps('souce',
              {
        ...
        <FormItem {...formItemLayout} label="上报单位" key='3'>
        ...
        <FormItem {...formItemLayout} label="区域" key="4">
        ...
        <FormItem {...formItemLayout} label="发布年份" key='5'>
  ...
  render() {
    ...
    return (
      <Modal
        title={this.props.obj.effective == "1" ? "移入" : "移除"}
        ...
        <Card bordered={false}>
          <Form>
            <FormItem {...formItemLayout} label="自然人姓名">
              {this.props.obj.legalPersonName}
            </FormItem>

            <FormItem {...formItemLayout} label="性别">
              {this.props.obj.gender == 0 ? '男' : '女'}
            </FormItem>

            <FormItem {...formItemLayout} label="身份证/护照号">
