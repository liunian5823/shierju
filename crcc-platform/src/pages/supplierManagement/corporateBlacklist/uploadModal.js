...
class ModalFormComponent extends React.Component {
  ...
  handleToExport = () => {
    ...
    window.open(
      ...
      '/api' +
      '/supplier/ecBlacklistCompany/downPersonBlackListFile'
    )
  }
          ...
          <Form>
            <FormItem {...formItemLayout}>
              <Upload
                ...
                action={SystemConfig.configs.axiosUrl + '/platform/blacklist/company/batchBacklegalPerson'}
            ...
            <FormItem {...formItemLayout}>
              还没有模板？请点击此处下载<a href='javascript:void(0);' onClick={this.handleToExport}>铁建商城自然人（法人）黑名单模板.xlsx</a>
            </FormItem>
          </Form>
        </Card>
      </Modal>
