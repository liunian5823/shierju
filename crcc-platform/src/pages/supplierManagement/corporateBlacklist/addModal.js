        ...
        <Card bordered={false}>
          <Form>
            <FormItem {...formItemLayout} label="自然人姓名">
              <Input type="text" maxLength='20' {...getFieldProps("legalPerson", {
                rules: [
                  {
                    required: true,
                    message: "请输入姓名"
                ...
                placeholder="请输入自然人（法人）姓名"></Input>
            </FormItem>
            <FormItem {...formItemLayout} label="性别">
              <Select placeholder="请选择性别" {...getFieldProps("gender", {
                rules: [
                  {
                    required: true,
                    message: "请选择性别"
            ...
            <FormItem {...formItemLayout} label="身份证/护照号">
              <Input type="text" maxLength='30' {...getFieldProps("legalPersonId", {
                rules: [
                  {
                    required: true,
                    message: "请输入身份证/护照号"
                ...
                placeholder="请输入与姓名一致的身份证/护照号"></Input>
            </FormItem>
