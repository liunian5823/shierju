                    ...
                    <div className={less.statis_title}>
                        ...
                        <p>
                            ...
                            <strong style={{fontSize: '22px', marginLeft: 10 ,color: evaluateObj.serverScore>0?"#fe4d4d":
                                ...
                                "#999"}}>
                                {
                                   evaluateObj.serverScore>0?(evaluateObj.serverScore>1?100:evaluateObj.serverScore*100).toFixed(2)+'%'+"↑":
                                   evaluateObj.serverScore<0?(evaluateObj.serverScore<(-1)?(-100):evaluateObj.serverScore*100).toFixed(2)+'%'+"↓":
                                   "-"
                                }
                            </strong>
                    ...
                    <div className={less.statis_title}>
                        ...
                        <p>
                            ...
                            <strong style={{fontSize: '22px', marginLeft: 10 ,color: evaluateObj.qualityScore>0?"#fe4d4d":
                                ...
                                "#999"}}>
                                {
                                   evaluateObj.qualityScore>0?(evaluateObj.qualityScore>1?100:evaluateObj.qualityScore*100).toFixed(2)+'%'+"↑":
                                   evaluateObj.qualityScore<0?(evaluateObj.qualityScore<(-1)?(-100):evaluateObj.qualityScore*100).toFixed(2)+'%'+"↓":
                                   "-"
                                }
                            </strong>
                    ...
                    <div className={less.statis_title}>
                        ...
                        <p>
                            ...
                            <strong style={{fontSize: '22px', marginLeft: 10 ,color: evaluateObj.pirceScore>0?"#fe4d4d":
                                ...
                                "#999"}}>
                                {
                                   evaluateObj.pirceScore>0?(evaluateObj.pirceScore>1?100:evaluateObj.pirceScore*100).toFixed(2)+'%'+"↑":
                                   evaluateObj.pirceScore<0?(evaluateObj.pirceScore<(-1)?(-100):evaluateObj.pirceScore*100).toFixed(2)+'%'+"↓":
                                   "-"
                                }
                            </strong>
