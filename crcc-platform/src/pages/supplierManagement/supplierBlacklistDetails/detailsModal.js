      ...
      footer={<span></span>}>
        ...
        <Row>
            <Col span={12}>
              ...
              {moment(this.props.info.blackTime).format('YYYY-MM-DD HH:mm:ss')}
              </BaseDetails>
            </Col>
            <Col span={12}>
          ...
          <Row>
            <Col span={12}>
              ...
              {this.props.info.effective=="1"?"失效":this.props.info.effective=="0"?"生效":"拉黑"}
              </BaseDetails>
            </Col>
            <Col span={12}>
          ...
          <Row>
            <Col span={12}>
              ...
              {this.props.info.rating=="0"?'黑':this.props.info.rating=='1'?'灰':'黄'}
              </BaseDetails>
            </Col>
            <Col span={12}>
