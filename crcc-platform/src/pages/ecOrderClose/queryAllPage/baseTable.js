...
class baseTable extends React.Component {
  ...
  tableSort = (pagination, filters, sorter) => {
    console.log('1234123');
    this.props.returnPage(pagination)
    if (sorter.field) {
      let pageNum = 1;
  ...
  renderAlert = () => {
    if (this.props.alertContent) {
      return <Alert message={this.props.alertContent + ' : ' + this.state.total} type="info" showIcon />
    }
    return null
  }
    ...
    return (
      <div>
        ...
        <Table
          ...
          dataSource={this.state.dataSource.rows == undefined ? this.state.dataSource.list : this.state.dataSource.rows}
