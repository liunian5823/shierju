...
class HelpAddCenterFormComponent extends React.Component {
    visible = false;
    state = {
        html: "",
    ...
    componentWillMount() {
      this.selectClass();
      this.props.form.setFieldsValue({helpType: this.state.classId});
      }
    ...
    optionsList = () => {
        ...
        flatNavList(this.state.selectList)
        return options
    }
...
export default Form.create()(HelpAddCenterFormComponent);