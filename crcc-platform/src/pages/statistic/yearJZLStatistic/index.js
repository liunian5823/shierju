...
class YearJZLStatistic extends React.Component {
        constructor(props) {
        super(props);
            this.state = {
        ...
        //获取撮合交易金额
        getData = params => {
            api.ajax('GET',"@/statistics/yearStatistic/selectJZL", {
                ...params
            }).then(r => {
                this.setState({
        ...
        //获取撮合交易金额总金额
        getTotalM = params => {
            api.ajax('GET',"@/statistics/yearStatistic/selectJZLSum", {
                ...params
            }).then(r => {
                this.setState({
                    dataTotal: r.data,
...
export default Form.create()(YearJZLStatistic);