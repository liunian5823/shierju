...
class YearStatistic extends React.Component {
        constructor(props) {
        super(props);
            this.state = {
        ...
        //获取平台采购量
        getData = params => {
            api.ajax('GET',"@/statistics/yearStatistic/selectYearPurchase", {
                ...params
            }).then(r => {
                this.setState({
        ...
        //获取平台采购总金额
        getTotalM = params => {
            api.ajax('GET',"@/statistics/yearStatistic/selectYearPurchaseSum", {
                ...params
            }).then(r => {
                this.setState({
                    dataTotal: r.data,
...
export default Form.create()(YearStatistic);