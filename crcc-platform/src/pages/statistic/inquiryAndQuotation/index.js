...
class InquiryAndQuotation extends React.Component {
        constructor(props) {
        super(props);
            this.state = {
        ...
        //获取询报价订单交易总金额（局）
        getData = params => {
            api.ajax('GET',"@/statistics/inquiryStatistic/queryFinishOrderTotalPrice", {
                ...params
            }).then(r => {
                var data =[];
                data = r.data.rows;
...
export default Form.create()(InquiryAndQuotation);