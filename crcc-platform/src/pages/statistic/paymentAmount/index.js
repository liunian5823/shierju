...
class PaymentAmount extends React.Component {
        ...
        //获取支付金额
        getData = params => {
            api.ajax('GET',"@/statistics/payStatistic/payOnlineStatistice", {
                ...params
            }).then(r => {
                this.setState({
                    dataInfo: r.data.rows,
                    sumPrice: r.data.sum.sumTotalPrice,
                    loading: false
                })
            });
        }
            ...
            return(
                <div>
                    <Card bordered={false} className="cards">
                        ...
                        <h3 style={{marginBottom: "15px",zIndex: 999, display : "inline-block", position:"relative"}}>支付总金额: {sumPrice}</h3>
                        <Table
                            dataSource={dataInfo}
...
export default Form.create()(PaymentAmount);