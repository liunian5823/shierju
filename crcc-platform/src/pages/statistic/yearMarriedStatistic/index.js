...
class YearMarriedStatistic extends React.Component {
        constructor(props) {
        super(props);
            this.state = {
        ...
        //获取撮合交易金额
        getData = params => {
            api.ajax('GET',"@/statistics/yearStatistic/selectMarriedDeal", {
                ...params
            }).then(r => {
                this.setState({
        ...
        //获取撮合交易金额总金额
        getTotalM = params => {
            api.ajax('GET',"@/statistics/yearStatistic/selectMarriedDealSum", {
                ...params
            }).then(r => {
                this.setState({
                    dataTotal: r.data,
            ...
            return(
                <div>
                    <Card bordered={false} className="cards">
                        ...
                        <h3 style={{marginBottom: "15px",zIndex: 999, display : "inline-block", marginLeft : "20px", position:"relative"}}>撮合交易总金额: {dataTotal.chjyzesum ? dataTotal.chjyzesum : "0" }</h3>
                        <Table
                            dataSource={dataInfo}
...
export default Form.create()(YearMarriedStatistic);