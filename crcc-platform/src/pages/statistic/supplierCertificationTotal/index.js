...
class SupplierCertificationTotal extends React.Component {
        constructor(props) {
        super(props);
            this.state = {
        ...
        //获取供应商认证数量
        getData = params => {
            api.ajax('GET',"@/statistics/payStatistic/legSupplyerStatistice", {
                ...params
            }).then(r => {
                this.setState({
                    dataInfo: r.data,
            ...
            return(
                <div>
                    <Card bordered={false} className="cards">
                        ...
                        <h3 style={{marginBottom: "15px",zIndex: 999, display : "inline-block", position:"relative"}}>供应商认证数量: { dataInfo ? dataInfo : "0" }</h3>
                    </Card>
                </div>
            )
        }
}
export default Form.create()(SupplierCertificationTotal);