...
class YearInquiryCountStatistic extends React.Component {
        constructor(props) {
        super(props);
            this.state = {
        ...
        //获取撮合交易金额
        getData = params => {
            api.ajax('GET',"@/statistics/yearStatistic/selectInquiryCount", {
                ...params
            }).then(r => {
                this.setState({
...
export default Form.create()(YearInquiryCountStatistic);