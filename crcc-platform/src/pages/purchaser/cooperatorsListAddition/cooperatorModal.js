...
class CooperatorModal extends React.Component {
    ...
    addCooperator () {
        ...
        axios.get('!!/purchaser/attachment/addCooperator', {
            params:{ ...params }
        }).then((r, err) =>{
            if(r.data){
                ...
                axios.get('!!/purchaser/attachment/checkAttachment', {
                    ...
                    Util.alert('该合作单位已被您添加到清单',{ type: 'warning' })
                })
            }
        })
    }
                ...
                >
                    <Form>
                        <Row type="flex" justify="center" gutter={16}>
                            <Col span={9} >
                                <Form.Item >
                                    <Input placeholder="请输入合作单位名称"  {...getFieldProps('companyName')}/>
                                </Form.Item>
                            </Col>
                            <Col span={3} >
    ...
    export default Form.create()(CooperatorModal)
