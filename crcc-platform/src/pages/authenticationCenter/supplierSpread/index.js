...
const geoCoordMap = {
  ...
  柳州市: [109.4, 24.33],
  // 分隔
  黔南布依族苗族自治州: [107.512565,26.267066],
  昌吉回族自治州: [89.183159,44.009009],
  //分隔
...
export default class EchartsRadar extends Component {
      ...
      series: [
        {
          ...
          function(val) {
            let _val = val[2] / 10 * 3;
            _val = _val < 10 ? 6 : (_val > 25 ? 25 : _val);
            return _val
          },
          label: {
            normal: {
        ...
        },
        {
          ...
          symbolSize: function(val) {
            let _val = val[2] / 10 * 3;
            _val = _val < 20 ? 20 : (_val > 21 ? 21 : _val);
            return _val
          },
          showEffectOn: "render",
          rippleEffect: {
  ...
  getSpread = () => {
    api
      .ajax("GET", "@/statistics/supplerStatistic/supplierCityCount", {})
      .then(r => {
        this.setState({
          data: r.data.listCity
        });
      })
      .catch(r => {
  ...
  render() {
    ...
    return (
      <div className="echartsRadar" style={{ width: "100%", height: "100%" }}>
        <ReactEcharts
