                ...
                <div style={{padding:"24px"}}>
                    ...
                    <Row>
                        <Col span={10} className={less.mb0}>
                            <FormItem label={getDetailsLabel("下单人")} {...detailsLayout}>
                                <p>{this.props.selectedRow.username}</p>
                            </FormItem>
                        </Col>
                        <Col span={10} className={less.mb0}>
                            <FormItem label={getDetailsLabel("来款账户名")} {...detailsLayout}>
                    ...
                    <Row>
                        <Col span={10}>
                            <FormItem label={getDetailsLabel("联系电话")} {...detailsLayout}>
                                <p>{this.props.selectedRow.phone}</p>
                            </FormItem>
                        </Col>
                        <Col span={10}>
                            <FormItem label={getDetailsLabel("来款金额")} {...detailsLayout}>
                    ...
                    <Row>
                        <Col span={24}>
                            <FormItem label={getDetailsLabel("上传附件")} {...detailsLayout}>
                                <Upload
                    ...
                    <Row>
                        <Col span={24}>
                            <FormItem label={getDetailsLabel("备注信息")} {...detailsLayout}>
                    ...
                    <Row>
                        <Col span={24}>
                            <FormItem label={getDetailsLabel("手机号码")} {...detailsLayout}>
                    ...
                    <Row>
                        <Col span={21}>
                            <FormItem label={getDetailsLabel("短信验证")} {...detailsLayout}>
