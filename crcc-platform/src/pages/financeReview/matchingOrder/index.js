...
import api from '../handleFinanceReview/node_modules/@/framework/axios';
import {getDetailsLabel, detailsLayout} from  '../handleFinanceReview/node_modules/@/components/gaoda/Details';
import {NumberFormat} from "../handleFinanceReview/node_modules/@/components/gaoda/Format";
import {exportFile} from '../handleFinanceReview/node_modules/@/utils/urlUtils';
import {getUrlByParam, getQueryString} from '../handleFinanceReview/node_modules/@/utils/urlUtils';
...
class matchingOrder extends React.Component{
    state = {
    ...
    sendPhoneCode = ()=>{
        this.intervalTime()
        //发送验证码
        api.ajax("GET","!!/financial/financeHang/getMatchingOrderCode").then((r) => {
    ...
    onMatchingOrderOk = ()=>{
        this.props.form.validateFieldsAndScroll((errors, values) => {
            ...
            confirm({
                ...
                content: '是否确认匹配订单',
                onOk() {
                    api.ajax("GET", "!!/financial/financeHang/matchingOrder", {
                        ...param
                    }).then((r) => {
                        if (!_this._isMounted) {
                            return;
    ...
    render() {
        ...
        return(
            <Modal
                ...
                width = "935px"
                onOk = {this.onMatchingOrderOk}
                onCancel = {this.onCancel}
                wrapClassName = {less.matchingOrder+" matchingOrder"}
            >
                <div style={{padding:"24px"}}>
                    ...
                    <Row  className={less.title}>
                        ...
                        <Col span={10}>
                            ...
                            <Row className={less.text}>
                                {this.props.selectedRow.orderNo}
                            </Row>
                        </Col>
                        <Col span={4}>
                            <Row className={less.label}>
                            ...
                            <Row className={less.text}>
                                {this.props.selectedRow.totalPrice?<span>¥ <NumberFormat value={this.props.selectedRow.totalPrice}/></span>:null}
                            </Row>
                        </Col>
                    </Row>
                    <Row>
                    ...
                    {/*<Row>
                        <Col span={24} className={less.mb0}>
                            <FormItem label={getDetailsLabel("订单金额")} {...detailsLayout}>
                    ...
                    <Row>
                        <Col span={24}>
                            <FormItem label={getDetailsLabel("订单编号")} {...detailsLayout}>
                    ...
                    <Row>
                        <Col span={24} className={less.mb0}>
                            <FormItem label="采购单位" {...detailsLayout}>
                                <p>{this.props.selectedRow.buyerCompanyName}</p>
                            </FormItem>
                        </Col>
                    </Row>
                    <Row>
                        <Col span={24}>
                            <FormItem label="采购部门" {...detailsLayout}>
                                <p>{this.props.selectedRow.organizationName}</p>
                            </FormItem>
                        </Col>
                    </Row>
                    <Row>
...
export default Form.create()(matchingOrder);