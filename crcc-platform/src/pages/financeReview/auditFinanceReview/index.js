...
class DetailFinanceReview extends React.Component{
    ...
    componentWillMount(){
        ...
        api.ajax("GET", "@/platform/checkingOnAccount/findCheckingOnAccountBySingular",{ 
            ...
            console.log('hhhhhh',this.state.listFinanceHangHandleOrders.workOrdersId)
        })
    ...
    platDetail = (id,uuids) => {
        setTimeout(() => {
            ...
            // this.props.history.push('/financialCenter/platSettlementListNew/settlementDetailNew/'+id+'/'+uuids);
        }, 500)
      ...
      columns4 = () => {
        return [
            ...
            },
            {
                ...
                width: 200,
                render:(text,record)=> {
                    return  <span style={{width: "190px"}} className={less.plat_table_text} title={text}>{text}</span>
                }
            },
            {
                title: '结算单',
