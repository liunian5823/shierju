...
class BgAuditForDetails extends React.Component {
	_userInfo = null;
	legalType = null;
  state = {
	status: null,//公司状态
  ...
  getCompanyInfo = (id, workUuids) => {
    ...
    this.legalType= r.data.legalType;
      this.setState({
		...
		companyId: r.data.id,
		baseParams: {workOrdersType: 5, companyId: r.data.companyId, workUuids: workUuids, license : r.data.businessLicense},
        ...
        <Row gutter={16}>
          <Col span={12}>
            <FormItem {...formItemLayout} label="管理员姓名">
              <Input disabled type="text" maxLength='50' disabled={true} style={{color: this.state.color}}
        ...
        <Row gutter={16}>
          <Col span={12}>
            <FormItem {...formItemLayout} label="管理员手机号">
              <Input disabled type="text" maxLength='11' disabled={true} style={{color: this.state.color}}
...
export default Form.create()(BgAuditForDetails);