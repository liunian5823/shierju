...
class threeLevelCompany extends React.Component{
    state = {
    ...
    componentWillMount(){
        ...
        api.ajax("GET", "!!/purchaser/cecommendedSupplierStatistics/getThreeLevelCompanyStatistics",{
            twoLevelCompanyUuids:getQueryString('twoLevelCompanyUuids')
        }).then((r) => {
            if(this._isMounted){
                if(r.data){
                    this.setState({
     ...
     */
        //展示的字段
    importantFilter = ['threeLevelCompanyName', 'adminName']
    ...
    columns = () => {
        return [
            ...
            // {
            //     title: '已驳回数量',
            //     dataIndex: 'subRecommendStateTwoCount',
                    ...
                    <p style={{width:"144px"}}>
                        <a onClick={
                            ()=>{
                                ...
                                param.threeLevelCompanyUuids = record.threeLevelCompanyUuids
                        ...
                        <a onClick={
                            ()=>{
                                ...
                                param.source = 3
                                param.uuids = record.threeLevelCompanyUuids
    ...
    export = () => {
        exportFile('/purchaser/cecommendedSupplierStatistics/exportThreeLevelCompanyList',{...this.baseParams})
    }
        ...
        return(
            <div>
                ...
                <Card bordered={false} className="mb10">
                    ...
                    <BaseTable
                        url='!!/purchaser/cecommendedSupplierStatistics/getThreeLevelCompanyListForPage'
                ...
                <BaseAffix>
                    <Button style={{marginRight: "10px"}} type="primary" onClick={()=>{this.props.history.push('/purchaser/twoLevelCompany')}}>返回</Button>
                </BaseAffix>
            </div>
        )
    }
...
export default threeLevelCompany;