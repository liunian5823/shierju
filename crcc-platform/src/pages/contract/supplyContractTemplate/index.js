...
import SupplyContractTemplateModal from './supplyContractTemplateModal'

const TabPane = Tabs.TabPane;

class supplyContractTemplate extends React.Component{
  state = {
      loading: false,
      ...
      dataSourceList:[],
      updateSupplyContractTemplateModalVisible:false,
      id:'',
  }
  ...
  formList = [
    ...
    updateSupplyContractTemplateCallback=()=>{
        this.reloadData();
        this.setState({
            updateSupplyContractTemplateModalVisible:!this.state.updateSupplyContractTemplateModalVisible
        })

    }

    updateSupplyContractTemplateModalShow=()=>{
        this.setState({
            updateSupplyContractTemplateModalVisible:false
        })
    }
  ...
  resetTable = (state, tableState = 'tableState') => {
    ...
    updateContractTemplateToVoid=(id)=>{
        ...
        this.getCurrentBean(id).then(function(data){
            ...
            if (null != data && data.delFlag == 0 ) {
                if (data.conState != 3 ) {
                    that.setState({
                        updateSupplyContractTemplateModalVisible:true
                        ,id:id
                    })
                } else {
    ...
    getEffectiveDeadline = () => {
        ...
        api.ajax('GET', '!!/common/contractTemplate/listContractTemplateEffectived',{
            ...
            if (r.data.length>0) {
                that.props.history.push("/contract/addSupplyContractTemplate")
            } else {
    ...
    return(
      <div>
        <Card bordered={false} style={{background:"rgba(240,242,245,1)"}} className="yuyuyuy">
            <Card bordered={false}  className="erert">
              <BaseForm
                ...
                <div className="contractTemplatetoolbar">
                    ...
                    } style={{marginLeft:"8px"}}>发布补充协议</Button>
                </div>
          ...
          <SupplyContractTemplateModal
              visble={this.state.updateSupplyContractTemplateModalVisible}
              id={this.state.id}
              onClose={this.updateSupplyContractTemplateModalShow}
              callback={this.updateSupplyContractTemplateCallback}
          />
      </div>
    )
  }
}
export default supplyContractTemplate