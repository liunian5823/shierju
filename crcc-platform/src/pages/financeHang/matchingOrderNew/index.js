      ...
      axios.get("@/contend/phone/msg/provingPhoneMsg", {
        ...
        if (r.data == true) {
          this.setState({
            ...
            api.ajax("GET", "@/platform/financehang/submitSettlement", {
                ...param
            }).then((r) => {
            ...
            //    else{
            //     message.error('挂账到款金额与结算单金额不匹配,不能匹配结算单')
            //     this.setState({
            //         visible2:false
            //     })
            //    }
            ...
            console.log('999',values)
                ...
                api.ajax("GET", "@/platform/config/getApprovalStatus").then((r) => {
                    ...
                    if(this.state.approvalStatus.approval == 0){
                        ...
                        console.log("this.props.getApprovalStatus.approval", this.props.getApprovalStatus.approval)
                        console.log("this.props.getApprovalStatus.approval", this.props.getApprovalStatus.approval)
                        // if (this.props.getApprovalStatus.approval == "0") {
            ...
            >
                ...
                <Row style={{marginLeft:'36px'}}>
                        ...
                        <Col span={11}>
                            ...
                            <Row>
                                <p>来款附言：</p>
                                <p className={less.text} style={{color:"rgba(0,0,0,0.85)",fontWeight: "bold",fontSize:"20",paddingBottom:"16px"}}>{this.props.selectedRow.payCode?this.props.selectedRow.payCode:"-"}</p>
                            </Row>
                        </Col> 
                    </Row>
                                </Modal>
                ...
                <Modal title="匹配结算单" visible={this.state.visible2}
