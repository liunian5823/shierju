...
class DisposeModal extends React.Component {
  ...
  componentDidUpdate() {
    if (this.visible != this.props.visible) {
      ...
      this.setState({
        type: this.props.disposeIndex
      })
      this.props.form.setFieldsValue({ type: this.props.disposeIndex + '' });
    }
  }
  ...
  handleOk = () => {
    this.props.form.validateFieldsAndScroll((errors, values) => {
      ...
      values.companyName = this.props.formData.name
      values.businessLicenseNo = this.props.formData.businessLicense;
      values.legalPersonId = this.props.formData.legalPersonId
    ...
    return (
      <Modal
        ...
        <Form>
          ...
          {this.renderGenter(this.state.type)}
          <FormItem
            label='法人身份证/护照号'
            {...formItemLayout}>
