...
class GoodsSearchSet extends React.Component {
    state = {
        loading: false,
        submitFlag:false,
        visible:false,
    ...
    submitData=()=>{
        this.props.form.validateFieldsAndScroll((errors, values) => {
            ...
            let url = "@/merchandise/ecGoods/resetAllGoodsIndex";
            let msgError = "重置失败";
    ...
    render() {
        ...
        return (
            <div >
                <Form>
                    <Card title={<div className="xiugaibt">重置商品索引</div>}	bordered={false} className="minheight">
                        <FormItem {...formItemLayout} label="开始ID：" required>
                            <Input type="text" maxLength='10'
                                   placeholder="请填写商品开始ID"
                ...
                <Modal title="全部更新" visible={this.state.visible}
                        ...
                        <p>是否确定更新全部商品索引？执行该操作前先将商品索引清空！！该功能需要长时间等待！！</p>
                </Modal>
            </div>
...
export default Form.create()(GoodsSearchSet);