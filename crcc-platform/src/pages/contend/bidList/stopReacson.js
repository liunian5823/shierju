...
class stopReacson extends Component {
      ...
      <div>
        ...
        >
          <div className={less.reason_modal_container}>
            <Spin spinning={false}>
              <Form>
                <FormItem label={<span style={{ width: '70px' }}>竞价单号</span>} labelCol={{ span: 5 }} wrapperCol={{ span: 19 }}>
...
Form.create({})(stopReacson)
export default connect(mapStateToProps)(Form.create({})(stopReacson));