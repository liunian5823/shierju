...
import OrderBaseForDetail from './orderBaseForDetail';
    ...
    render() {
        return (
            <div className="order-allBaseDetail">
                <OrderBaseForDetail enableChildrenList={this.props.enableChildrenList} data={this.state.dataSource} refresh={this.props.refresh}/>
                <Form horizontal>
                        ...
                        <Row {...ComponentDefine.row_}>
                            <Col span={12} className="ant-form-item-margin-bottom">
                                <BaseDetails title="收货人">
                                    {this.state.dataSource.receiveName}
                                </BaseDetails>
                            </Col>
                            <Col span={12} className="ant-form-item-margin-bottom">
                                <BaseDetails title="联系电话">
