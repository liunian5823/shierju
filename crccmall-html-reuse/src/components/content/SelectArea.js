...
class SelectArea extends React.Component {
    ...
    hideSelect = () => {
        ...
        this.arrStr = arrStr;
        if(arrStr != "" && arrStr.indexOf("_") == -1) {
            let newArrStr = [...this.state.treeChecked.checked];
            if(arrStr.indexOf("DB") > -1) {
                newArrStr.push("DB_210000", "DB_220000", "DB_230000")
            }if(arrStr.indexOf("HB") > -1) {
                newArrStr.push("HB_110000", "HB_120000", "HB_130000", "HB_140000", "HB_150000")
            }if(arrStr.indexOf("HD") > -1) {
                newArrStr.push("HD_310000","HD_320000","HD_330000","HD_340000","HD_350000","HD_360000","HD_370000","HD_710000")
            }if(arrStr.indexOf("HN") > -1) {
                newArrStr.push("HN_440000","HN_450000","HN_460000","HN_810000","HN_820000")
            }if(arrStr.indexOf("HZ") > -1) {
                newArrStr.push("HZ_410000","HZ_420000","HZ_430000")
            }if(arrStr.indexOf("XB") > -1) {
                newArrStr.push("XB_610000","XB_620000","XB_630000","XB_640000","XB_650000")
            }if(arrStr.indexOf("XN") > -1) {
                newArrStr.push("XN_500000","XN_510000","XN_520000","XN_530000","XN_540000")
            }
            this.props.onOK(newArrStr.join(','));
            return;
        }
