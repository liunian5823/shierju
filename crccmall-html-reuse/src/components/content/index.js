...
class details extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.areaData && (this.arrStr != nextProps.areaData)) {
      this.arrStr = nextProps.areaData;
      //仅触发第一次赋值操作
      this.initData(nextProps.areaData.split(','));
    }
  }
  ...
  initData = (data) => {
    ...
    this.initDataAjax();
    this.setState({
      treeChecked: { checked: data, halfChecked: halfCheckedData },
    })
  }
            ...
            <Row className={[less.table_area, 'select_area_tree'].join(' ')}>
              ...
              <Col span="6" className={less.table_box}>
                <div className={less.table_box_list}>
                  ...
                  >
                    {this.renderTree(this.state.city, 'city')}
                  </Tree>
                </div>
              </Col>
              <Col span="6" className={less.table_box}>
