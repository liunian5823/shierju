...
export default class BuySceneOffer extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            spinning: false,
            ...
            <div className={less.info}>
                ...
                <Row className="reuse_row">
                    ...
                    <Col className="reuse_value" span={span[1]}>
                        ...
                        <span className="ml20">
                            将于
                            <span className={less.signEndTime_diff}> {FormatDate.formatTimeDiff(bidData.signEndTime)} </span>
                            天后截止
                        </span>
            ...
            <div className={less.scene_detail}>
                <Spin spinning={this.state.spinning}>
                    <div ref={(ref) => this.refs = ref} style={{ marginBottom: '80px' }}>
                        ...
                        <Card title="竞价产品" className="mt10">
                            <Table dataSource={this.state.offerList}
                                columns={this.offerListCols}
                                scroll={{ x: 1200 }}
                                pagination={false} />
                            <div className="mt10 mb10 text_r">
                                <span style={{ fontSize: '20px', fontWeight: 'bold' }}>总价：<span className="color_e bo_25">￥{numeral(this.state.amt || 0).format('0,0.00')}</span>元</span>
                            </div>
                        </Card>
                    </div>
