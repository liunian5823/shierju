...
class User extends React.Component {
    ...
    columns = [{
        ...
        render: (text, record, index) => {
            return <p className="user-tableColumnWidth" style={{ width: "50px" }}><span title={text}>{index + 1}</span></p>
        },
    }, {
        title: '姓名',
        dataIndex: 'username',
        ...
        render: (text, record) => {
            ...
            if (arr.includes('13')) {//包含公司管理
                ...
                return (<span>
                    ...
                    <span className="ant-divider"></span>
                    <PermissionsBtn only>
                        <Popconfirm title="是否确认删除该人员?" onConfirm={this.deleteUser.bind(this, record.uuids)}><a>删除</a></Popconfirm>
                    </PermissionsBtn>
                </span>)
            }
        }
